        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Dojos and Ninjas - New Dojo</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container w-75">
                            ...
                            <!-- == Create Dojo button == -->
                            <!-- <p class="w-100"></p>
                            <a class="btn btn-primary float-end mb-3 me-3" href="/dojos/newDojo">Create Dojo</a>
                            <p class="w-100"></p> -->
                            <!-- == Dashboard button == -->
                            <p class="w-100"></p>
                        ...
                        <div class="container text-center mt-5">
                            ...
                            <div>
                                ...
                                <h3 class="bg-primary text-light ps-5">Create a Dojo</h3>
                            </div>
                            <p class="w-100"></p>
                            ...
                            <div
                                ...
                                <form:form action="/dojos/newDojo" method="post" modelAttribute="dojo">
                                    ...
                                    <input type="submit" value="Add New Dojo" class="btn btn-warning float-start" />
                                    <!-- == Cancel button == -->
                                    <p class="w-100"></p>
                                    <a class="btn btn-info float-end mb-3" href="/dojos/dashboard">Cancel</a>
                                    <p class="w-100"></p>
