        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Dojos and Ninjas - Show One Dojo</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container text-center mt-5">
                            ...
                            <div>
                                ...
                                <br>
                                <h3 class="bg-primary text-light ps-5">${dojo.name} Ninjas </h3>
                            </div>
                            <p class="w-100"></p>
                            ...
                            <nav id="navbar-scrollspy" class="navbar navbar-light bg-light px-1">
                                <table class="table table-striped p-2 border border-2">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="h4 text-center">First Name</th>
                                            <th scope="col" class="h4 text-center">Last Name</th>
                                            <th scope="col" class="h4 text-center">Age</th>
                                        </tr>
                                    </thead>
                                </table>
                            </nav>
                                ...
                                <table class="table table-striped p-2 border border-2">
                                    <tbody>
                                        <c:forEach var="ninja" items="${dojo.ninjas}">
                                            <tr>
                                                <td class="h4 text-center">${ninja.firstName}</td>
                                                <td class="h4 text-center">${ninja.lastName}</td>
                                                <td class="h4 text-center">${ninja.age}</td>
                                            </tr>
